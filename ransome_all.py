...
# Configuration - SAFE TESTING VERSION
TARGET_DIRS = ["test_files"]  # Only targets test_files directory for safety
...
if __name__ == "__main__":
    # Safety check - only runs in test_files directory
    if not os.path.exists("test_files"):
        os.makedirs("test_files", exist_ok=True)
        print("Created test_files directory for safe testing")
        print("Place test files in this directory before running again")
    else:
        main()
